...
boxplot(SENSPLT0 ~ districtName, data = district, 
        outline = FALSE, las = 2, ylab = "")#does not include outliers 
#---work on removing title! districtName
```
