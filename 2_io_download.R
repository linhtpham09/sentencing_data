...
query2002 <- dbSendQuery(con, "select `SENTDATE`,`SENSPLT0`, 
                          `GLMIN`, `GDLINEHI`,`TOTCHPTS`, `IS924C`, `WEAPSOC`, 
                          `STATMIN`, `CAROFFAP`, `ACCAP`, `DEPART`,`SAFE`,
                          `NEWCNVTN`, `PRESENT`, `MITROLHI`,`AGGROLHI`, `NEWRACE`, 
                          `MONSEX`, `AGE`,`EDUCATN`,`NEWEDUC`, `NEWCIT`, `REASON1`, 
                          `REASON2`, `REASTXT1`, `REASTXT2`, `REASTXT3`, 
                          `SOURCES`,`DISTRICT`, `CIRCDIST`, 
                          `ACCCAT`, `WEAPON`,`XFOLSOR`,`VIOL1PTS`
                           from opafy02nid")

#No BOOKERCD, SENTRNGE, MAND 
...
# # ----------------------2003-----------------------------------
# query2003 <- dbSendQuery(con, "select `sentdate`, `sensplt0`, `glmin`,`gdlinehi`,
#                             `totchpts`, `is924c`, `weapsoc`, `statmin`, `caroffap`,
#                             `accap`,`depart`, `safe`, `newcnvtn`,`present`,
#                             `mitrolhi`, `aggrolhi`, `newrace`, `monsex`,`age`,
#                             `educatn`,`newcit`,`district`,`circdist`, `REASTXT1`,
#                             `REASTXT2`, `REASTXT4`, `REASTXT6`, `REASON4`, `REASON5`,
#                             `REASON6`, `SOURCES`,``
#                             from opafy03nid")
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
query2003 <- dbSendQuery(con, "select `sentdate`, `sensplt0`, `glmin`,`gdlinehi`,
                            ...
                            `mitrolhi`, `aggrolhi`, `newrace`, `monsex`,`age`,
                            `educatn`,`newcit`,`district`,`circdist`, `REASTXT1`,
                            `REASTXT2`, `REASTXT3`,`REASTXT4`, `REASTXT5`,`REASTXT6`, 
                            `REASON4`, `REASON5`,`REASON6`, `SOURCES`,`statmin`, 
...
# # ----------------------2004-----------------------------------
query2004_1 <- dbSendQuery(con ,"select  `id`,`sensplt0`, `glmin`,  `totchpts`,
                                `is924c`, `weapsoc`,`statmin`, `caroffap`, 
                                `accap`,  `safe`,  `present`, `mitrolhi`, `aggrolhi`,
                                `newrace`, `monsex`, `age`, `educatn`,`newcit`, 
                                `sources`, `district`, `circdist`, `neweduc`, `acccat`,
                                `weapon`,`xfolsor`, `viol1pts`, `MAND1`,`MAND2`,
                                `MAND3`,`MAND4`,`MAND5`,`MAND6`
                                from fy04_1")
#no bookercd, sentrnge
#has mand 1-6
data2004_1 <- dbFetch(query2004_1)

query2004_2 <- dbSendQuery(con, "select `id`,`DEPART_A`,`SENTMON`,`SENTYR`,
                                `gdlinehi`,`newcnvtn`,`REAS1`, 
                                `REAS2`, `REAS3`, `REAS4`, `REAS5`,`REAS6` 
                                from fy04_2")
...
query2005_1 <- dbSendQuery(con, "select `id`,`sensplt0`, `glmin`, `totchpts`, 
                                `is924c`, `weapsoc`, `statmin`, `caroffap`,
                                `accap`,`safe`, `newcnvtn`, `present`, `mitrolhi`,
                                `aggrolhi`, `newrace`,`monsex`,`age`, `educatn`,
                                `newcit`, `sources`, `district`,`circdist`, `neweduc`,
                                `acccat`, `weapon`, `xfolsor`, `viol1pts`, 
...
# # ----------------------2006-----------------------------------
query2006 <- dbSendQuery(con, "select `SENTMON`, `SENTYR`, `SENSPLT0`,`GLMIN`, 
                              `GDLINEHI`, `TOTCHPTS`, `IS924C`, `WEAPSOC`, 
                              `STATMIN`, `CAROFFAP`, `ACCAP`, `BOOKERCD`,`SAFE`,
                              `NEWCNVTN`, `PRESENT`, `MITROLHI`, `AGGROLHI`,
                              `NEWRACE`, `MONSEX`, `AGE`, `EDUCATN`, `NEWCIT`,
                              `REAS1`, `REAS2`, `REAS3`, `REAS4`, `REAS5`,`REAS6`, 
                              `REAS7`, `REAS8`, `REAS9`, `REAS10`,`REAS11`, 
                              `REAS12`, `SOURCES`, `DISTRICT`,`CIRCDIST`,
                              `MAND1`,`MAND2`,`MAND3`,`MAND4`,`MAND5`,`MAND6`,
                              `NEWEDUC`,`ACCCAT`,`WEAPON`,`XFOLSOR`,`VIOL1PTS`
                              from opafy06nid")
...
# # ----------------------2007-----------------------------------
query2007_1<- dbSendQuery(con,"select `id`,`SENSPLT0`, `GLMIN`,  `TOTCHPTS`, 
                              `IS924C`, `WEAPSOC`, `STATMIN`, `CAROFFAP`, `ACCAP`, 
                              `SAFE`, `NEWCNVTN`, `PRESENT`, `MITROLHI`, 
                              `AGGROLHI`, `NEWRACE`, `MONSEX`, `AGE`, `EDUCATN`, 
                              `NEWCIT`, `SOURCES`,`DISTRICT`,`CIRCDIST`, 
                              `MAND1`,`MAND2`, `MAND3`, `MAND4`, `MAND5`, `MAND6`,
                              `NEWEDUC`, `ACCCAT`,`WEAPON`,`XFOLSOR`,`VIOL1PTS`
                              from fy07_1")
#has mand 1-6 

query2007_2 <- dbSendQuery(con, "select `id`, `SENTMON`, `SENTYR`, `GDLINEHI`,
                              `BOOKERCD`,`REAS1`, `REAS2`, `REAS3`, `REAS4`, 
                              `REAS5`, `REAS6`, `REAS7`, `REAS8`, `REAS9`,`REAS10`,
                              `REAS11`, `REAS12` 
                              from fy07_3")
...
# # ----------------------2008-----------------------------------
query2008_1 <- dbSendQuery(con, "select `id`, `SENSPLT0`, `GLMIN`, `TOTCHPTS`, 
                                `IS924C`, `WEAPSOC`, `STATMIN`,`CAROFFAP`, 
                                `ACCAP`, `SAFE`, `NEWCNVTN`, `PRESENT`, `MITROLHI`, 
                                `AGGROLHI`, `NEWRACE`, `MONSEX`, `AGE`, 
                                `EDUCATN`, `NEWCIT`, `SOURCES`,`DISTRICT`,
                                `CIRCDIST`,`MAND1`,`MAND2`,`MAND3`,`MAND4`,`MAND5`,
                                `MAND6`, `NEWEDUC`,`ACCCAT`,`WEAPON`,`XFOLSOR`,
                                `VIOL1PTS`
                                from fy08_1")

#has mand 1-6 

query2008_2 <- dbSendQuery(con, "select `id`, `SENTMON`, `SENTYR`,`GDLINEHI`,
                                `BOOKERCD`, `REAS1`, `REAS2`, `REAS3`, `REAS4`,
                                `REAS5`, `REAS6`, `REAS7`, `REAS8`, `REAS9`, 
                                `REAS10`,`REAS11`, `REAS12` from fy08_2")
...
# # ----------------------2009-----------------------------------
query2009_1 <- dbSendQuery(con, "select `id`, `SENTMON`, `SENTYR`, `SENSPLT0`,
                                `GLMIN`, `TOTCHPTS`, `IS924C`, `WEAPSOC`,
                                `STATMIN`, `CAROFFAP`, `ACCAP`, `BOOKERCD`,
                                `SAFE`, `NEWCNVTN`, `PRESENT`, `MITROLHI`, 
                                `AGGROLHI`, `NEWRACE`, `MONSEX`, `AGE`, `EDUCATN`, 
                                `NEWCIT`,`REAS1`, `REAS2`, `REAS3`, `REAS4`, 
                                `REAS5`, `REAS6`, `REAS7`, `REAS8`, `REAS9`, 
                                `REAS10`,`REAS11`, `REAS12`, `SOURCES`,`DISTRICT`,
                                `CIRCDIST`, `MAND1`,`MAND2`,`MAND3`,`MAND4`,`MAND5`,
                                `MAND6`,`NEWEDUC`,`ACCCAT`,`WEAPON`,`XFOLSOR`,
                                `VIOL1PTS`
                                from fy09_1")
...
query2010_1 <- dbSendQuery(con,"select `id`, `sentmon`, `sentyr`, `sensplt0`, 
                                `glmin`,  `totchpts`, `is924c`, `weapsoc`,
                                `statmin`,`caroffap`, `accap`, `bookercd`, `safe`, 
                                `newcnvtn`, `present`, `mitrolhi`, `aggrolhi`, 
                                `newrace`,`monsex`, `age`, `educatn`,`newcit`,
                                ...
                                `reas11`, `reas12`, `reas13`, `reas14`, `reas15`, 
                                `reas16`, `reas17`, `reas18`, `reas19`, `reas20`, 
                                `reas21`, `reas22`,`reas23`, `reas24`, `sources`, 
                                `district`,`circdist`, `neweduc`, `acccat`, `weapon`,
                                `xfolsor`,`viol1pts`, `mand1`, `mand2`,`mand3`,
                                `mand4`,`mand5`,`mand6`
                                from fy10_1" )
#has mand 1-6
...
# # ----------------------2011-----------------------------------
query2011_1 <- dbSendQuery(con, "select `id`,`SENTMON`, `SENTYR`, `SENSPLT0`, 
                                `GLMIN`,  `TOTCHPTS`, `IS924C`, `WEAPSOC`, 
                                `STATMIN`, `CAROFFAP`, `ACCAP`, `BOOKERCD`,
                                `SAFE`, `NEWCNVTN`, `PRESENT`, `MITROLHI`, 
                                `AGGROLHI`, `NEWRACE`, `MONSEX`, `AGE`, `EDUCATN`,
                                `NEWCIT`,`REAS1`, `REAS2`, `REAS3`, `REAS4`, 
                                `REAS5`, `REAS6`, `REAS7`, `REAS8`, `REAS9`, 
                                `REAS10`, `REAS11`, `REAS12`, `REAS13`, `REAS14`, 
                                `REAS15`, `REAS16`, `REAS17`, `REAS18`, `REAS19`,
                                `REAS20`, `REAS21`, `REAS22`, `REAS23`, `REAS24`, 
                                `SOURCES`,`DISTRICT`,`CIRCDIST`,`NEWEDUC`,`ACCCAT`,
                                `WEAPON`,`XFOLSOR`,`VIOL1PTS`,`MAND1`,`MAND2`,
                                `MAND3`,`MAND4`,`MAND6`
                                from fy11_1")
...
# ----------------------2012-----------------------------------
query2012_1 <- dbSendQuery(con, "select `id`, `SENTMON`, `SENTYR`, `SENSPLT0`, 
                                `GLMIN`,  `TOTCHPTS`, `IS924C`, `WEAPSOC`, 
                                `STATMIN`, `CAROFFAP`, `ACCAP`, `BOOKERCD`,
                                `SAFE`, `NEWCNVTN`, `PRESENT`, `MITROLHI`, 
                                `AGGROLHI`, `NEWRACE`, `MONSEX`, `AGE`, `EDUCATN`,
                                ...
                                `REAS15`, `REAS16`, `REAS17`, `REAS18`,`REAS19`,
                                `REAS20`, `REAS21`, `REAS22`, `REAS23`, `REAS24`,
                                `REAS25`, `REAS26`,`REAS27`, `REAS28`, `REAS29`, 
                                `REAS30`, `REAS31`, `REAS32`, `SOURCES`, `DISTRICT`, 
                                `CIRCDIST`, `NEWEDUC`, `ACCCAT`, `WEAPON`,`XFOLSOR`,
                                `VIOL1PTS`,`MAND1`, `MAND2`, `MAND3`, `MAND4`,
                                `MAND5`,`MAND6`
                                from fy12_1")
#has mand 1-6 
...
# # ----------------------2013-----------------------------------
query2013_1 <- dbSendQuery(con, "select `id`,`SENTMON`, `SENTYR`, `SENSPLT0`,
                                `GLMIN`,  `TOTCHPTS`, `IS924C`, `WEAPSOC`,
                                `STATMIN`, `CAROFFAP`,`ACCAP`, `BOOKERCD`, `SAFE`,
                                `NEWCNVTN`, `PRESENT`, `MITROLHI`, `AGGROLHI`, 
                                `NEWRACE`, `MONSEX`, `AGE`, `EDUCATN`,`NEWCIT`,
                                ...
                                `REAS11`, `REAS12`, `REAS13`, `REAS14`, `REAS15`, 
                                `REAS16`, `REAS17`, `REAS18`,`REAS19`, `REAS20`, 
                                `REAS21`, `REAS22`, `REAS23`, `REAS24`,`REAS25`,
                                `REAS26`,`REAS27`, `REAS28`, `REAS29`, `REAS30`,
                                `SOURCES`,`DISTRICT`,`CIRCDIST`, `NEWEDUC`, `ACCCAT`,
                                `WEAPON`,`XFOLSOR`,`VIOL1PTS`,`MAND1`,`MAND2`,
                                `MAND3`,`MAND4`,`MAND5`,`MAND6`
                                from fy13_1")
...
query2014_1 <- dbSendQuery(con, "select `id`,`SENTMON`, `SENTYR`, `SENSPLT0`, 
                                ...
                                `REAS11`, `REAS12`, `REAS13`, `REAS14`, `REAS15`, 
                                `REAS16`, `REAS17`, `REAS18`,`REAS19`, `REAS20`, 
                                `REAS21`, `SOURCES`, `DISTRICT`, `CIRCDIST`, 
                                `NEWEDUC`,`ACCCAT`, `WEAPON`, `XFOLSOR`,`VIOL1PTS`,
                                `MAND1`, `MAND2`, `MAND3`, `MAND4`, `MAND5`, `MAND6`
                                from fy14_1")
#has mand 1-6 
...
# # ----------------------2015-----------------------------------
query2015_1 <- dbSendQuery(con, "select `id`, `SENTMON`, `SENTYR`, `SENSPLT0`, 
                                `GLMIN`, `TOTCHPTS`, `IS924C`, `WEAPSOC`, 
                                `STATMIN`, `CAROFFAP`, `ACCAP`, `BOOKERCD`, 
                                `SAFE`, `NEWCNVTN`, `PRESENT`, `MITROLHI`, 
                                `AGGROLHI`, `NEWRACE`,`MONSEX`, `AGE`, `EDUCATN`,
                                ...
                                `REAS10`,`REAS11`, `REAS12`, `REAS13`, `REAS14`,
                                `REAS15`, `REAS16`, `REAS17`, `REAS18`,`REAS19`, 
                                `REAS20`, `SOURCES`, `DISTRICT`,`CIRCDIST`, 
                                `NEWEDUC`, `ACCCAT`, `WEAPON`, `XFOLSOR`, `VIOL1PTS`,
                                `MAND1`, `MAND2`, `MAND3`,`MAND4`, `MAND5`, `MAND6`
                                from fy15_1")
#has mand 1-6 
...
query2016_1 <- dbSendQuery(con, "select `id`,`SENTMON`, `SENTYR`, `SENSPLT0`, 
                                `GLMIN`,  `TOTCHPTS`,`IS924C`, `WEAPSOC`, 
                                `STATMIN`, `CAROFFAP`, `ACCAP`, `BOOKERCD`, 
                                `SAFE`, `NEWCNVTN`, `PRESENT`, `MITROLHI`, 
                                `AGGROLHI`, `NEWRACE`, `MONSEX`, `AGE`, `EDUCATN`,
                                ...
                                `REAS16`, `REAS17`, `REAS18`,`REAS19`, `REAS20`,
                                `REAS21`, `REAS22`, `REAS23`, `REAS24`,`REAS25`,
                                `REAS26`,`REAS27`, `REAS28`, `REAS29`, `SOURCES`,
                                `DISTRICT`,`CIRCDIST`, `NEWEDUC`, `ACCCAT`, 
                                `WEAPON`, `XFOLSOR`, `VIOL1PTS`,`MAND1`,`MAND2`,
                                `MAND3`, `MAND4`,`MAND5`,`MAND6`
                                from fy16_1")
#has mand 1-6 
