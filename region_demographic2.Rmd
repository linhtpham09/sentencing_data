---
title: "Regional Demographic Sentencing Disparities Baseline Switch"
output:
  html_document:
    df_print: paged
  word_document:
...
This document attempts to replicate the Commission's "refined model" for estimating demographic disparities in sentencing. However, this version is confined to the border districts identified in Fishman & Schazenbach (2012).
