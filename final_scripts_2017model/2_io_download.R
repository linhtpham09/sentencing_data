...
query2021_2 = dbSendQuery(con, "select `id`, `GDLINEHI` FROM fy21_3") #CML: Linh--is it right that this is fy21_3? shouldn't be 2?
...
#<<<<<<< HEAD:2_io_download.R

#=======
#>>>>>>> 46fce6aee265040039dac120446455ce2a7458ea:final_scripts_2017model/2_io_download.R
# ----------------------2022-----------------------------------
...
=======
                          `REAS19`,`REAS20`,`REAS21`, `REAS22`, `REAS23`, 
                          `REAS24`, `REAS25`,`REAS26`,`SOURCES`,`DISTRICT`,`CIRCDIST` 
>>>>>>> 46fce6aee265040039dac120446455ce2a7458ea:final_scripts_2017model/2_io_download.R
                          from fy22_1")
...
io_raw_2002_2023 <- bind_rows(data2002, data2003, data2004, data2005, data2006,
...
write_csv(io_raw_2002_2023, here::here("data/io_2002_2023.csv"))
#----------------CIRCDIST Column-----------------------
