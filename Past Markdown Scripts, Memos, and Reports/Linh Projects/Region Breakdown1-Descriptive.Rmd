...
Please note that all average sentence lengths are in months. Each section will include a H0 and H1, indicating a null (H0) hypothesis and an alternative (H1) hypothesis. This will identify what patterns or characteristic presents as an either an outlier or noteworthy. 
